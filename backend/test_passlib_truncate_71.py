...
try:
    with open("result_truncate_71.txt", "w") as f:
        f.write("Starting truncate test 71\n")
        ...
        try:
            ...
            if len(password_bytes) >= 72: # Truncate if >= 72 just in case
                truncated_pw = password_bytes[:71]
            else:
