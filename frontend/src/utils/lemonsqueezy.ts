 ...
 */
export function getLemonSqueezyCheckoutUrl(user?: CheckoutUserContext | null): string {
  try {
 ...
 */
export function openLemonSqueezyCheckout(user?: CheckoutUserContext | null): void {
  const checkoutUrl = getLemonSqueezyCheckoutUrl(user);
