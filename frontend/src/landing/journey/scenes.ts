...
export const SCENES: JourneyScene[] = [
  ...
  s('hero', { focus: [0.66, 0.5], tone: 'light', grade: [1.0, 0.04, 1.02], video: true }),
  // Night: the desk, the rain, the mugs
  s('problem', { focus: [0.62, 0.5], tone: 'dark', grade: [0.92, 0.08, 0.98] }),
  // Morning: the climb up the floating stairs
  s('solution', { focus: [0.6, 0.45], tone: 'light', grade: [1.0, 0.04, 1.0] }),
  // Golden hour: the studio above the city
  s('action', { focus: [0.72, 0.5], tone: 'light', grade: [1.0, 0.02, 1.0] }),
  // Sunset: two doors
  s('choice', { focus: [0.66, 0.5], tone: 'dark', grade: [0.95, 0.05, 1.02] }),
  // Late morning: Maya on her balcony
  s('client', { focus: [0.72, 0.45], tone: 'light', grade: [1.0, 0.02, 1.0] }),
];

// Blue hour: Kai and Pixel watching the lanterns rise
export const FINALE: JourneyScene = s('finale', { focus: [0.62, 0.55], side: 'center', tone: 'dark', grade: [0.9, 0.06, 1.0], video: true });
